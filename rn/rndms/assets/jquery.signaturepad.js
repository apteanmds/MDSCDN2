...
$.fn.signaturePad.defaults = {
  ...
  , name : '.printname' // The input field for typing a name
  ...
  , errorMessage : 'Please enter name' // The error message displayed on invalid submission
  , errorMessageDraw : 'Please sign' // The error message displayed when drawOnly and no signature is drawn
